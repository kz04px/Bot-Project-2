...
int line_line_intersection(s_vec2* val, s_vec2 w1_a, s_vec2 w1_b, s_vec2 w2_a, s_vec2 w2_b)
{
  ...
  if( x < min(x1, x2) || x > max(x1, x2) || x < min(x3, x4) || x > max(x3, x4) ) {return 2;}
  if( y < min(y1, y2) || y > max(y1, y2) || y < min(y3, y4) || y > max(y3, y4) ) {return 3;}
  ...
  /*
  float a = (w2_b.i - w2_a.i)*(w1_a.j - w2_a.j) - (w2_b.j - w2_a.j)*(w1_a.i - w2_a.i);
  float b = (w1_b.i - w1_a.i)*(w1_a.j - w2_a.j) - (w1_b.j - w1_a.j)*(w1_a.i - w2_a.i);
  float c = (w2_b.j - w2_a.j)*(w1_b.i - w1_a.i) - (w2_b.i - w2_a.i)*(w1_b.j - w1_a.j);
